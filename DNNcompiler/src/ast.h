...
class Hidding_Interval
{
  public:
    ...
    long GPU_mem_line;
    Tensor* the_tensor;
    Hidding_Interval(Tensor* t, long GPU_line){the_tensor = t; is_looped = false; is_offloaded = false; GPU_mem_line = GPU_line; original_prefetch_index = -1; evict_finish_index = -1;};
    void print();
};
