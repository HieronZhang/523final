...
void loadKernelTimes() {
    ...
    for (int i = 0; i < kernel_list.size(); i++) {
        ...
        total_time += kernel_list[i].execution_cycles;
        ...
        pf_total_time += kernel_list[i].pf_execution_cycles;
...
/***********************************Getting Motivation Number***************************************/
        ...
        std::ofstream motiv_1("Shanbao.txt");
        ...
        std::ofstream motiv_2("Sandian.txt");
